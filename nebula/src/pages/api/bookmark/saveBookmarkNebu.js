...
export default async function saveBookmark(req, res) {
  ...
  try {
    ...
    const checkQuery = `
      ...
      WHERE user_id = $1 AND nebu_id = $2;
    `;
    const checkValues = [userId, nebuId];
    ...
    const insertBookmarkQuery = `
      INSERT INTO bookmark (user_id, nebu_id)
      VALUES ($1, $2)
      RETURNING *;
    `;
    const insertBookmarkValues = [userId, nebuId];

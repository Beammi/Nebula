...
export default function Home() {
  ...
  return (
    <div className="relative h-screen">
      ...
      <div className={`fixed right-24 top-24 text-center text-white bg-blue flex flex-col rounded-lg font-bold items-center overflow-hidden ${addNebuDropDown ? 'opacity-100':'right-[-200px]'}`}>
        <Button

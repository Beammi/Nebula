      ...
      <>
        ...
        <div data-custom-class="body">
              ...
              <strong>
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="subtitle">
                    Last updated <bdt className="question">April 08, 2024</bdt>
                  </span>
                </span>
              </strong>
            </span>
                ...
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    ...
                    <span style={{ color: "rgb(0, 58, 250)" }}>
                      <bdt className="question">
                        <a
                          href="https://nebula-9q4xkfd90-ratchwalee-wongritdechakits-projects.vercel.app/"
                          target="_blank"
                          data-custom-class="link"
                        >
                          https://nebula-9q4xkfd90-ratchwalee-wongritdechakits-projects.vercel.app/
                        </a>
                      </bdt>
                    </span>
                    <span style={{ fontSize: 15 }}>
              ...
              <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                <span style={{ fontSize: 15, color: "rgb(89, 89, 89)" }}>
                  <span data-custom-class="body_text">
                    Download and use
                    <bdt className="block-component">
                      <bdt className="block-component" /> our Facebook
                      application
                      <bdt className="block-component">&nbsp;</bdt>(
                      <bdt className="question">Nebula)</bdt>
            ...
            <span style={{ fontSize: 15 }}>
              <span style={{ color: "rgb(127, 127, 127)" }}>
                <span data-custom-class="body_text">
                  ...
                  <bdt className="question">63011290@kmitl.ac.th</bdt>.
                </span>
              </span>
            </span>
          </div>
          ...
          <div style={{ lineHeight: "1.5" }}>
            ...
            <a
              data-custom-class="link"
              href="https://app.termly.io/notify/3e999684-3bfa-4b27-a533-4349daa09e64"
                ...
                <div style={{ lineHeight: "1.5" }}>
                  <span style={{ fontSize: 15 }}>
                    ...
                    <span data-custom-class="body_text">
                      ...
                      email, gender, birthday, current city, and profile picture
                      URL, as well as other information that you choose to make
                      public. We may also request access to other permissions
                      related to your account, such as friends, check-ins, and
                      likes, and you may choose to grant or deny us access to
                                            ...
                                            <li style={{ lineHeight: "1.5" }}>
                                              <span data-custom-class="body_text">
                                                <span style={{ fontSize: 15 }}>
                                                  ...
                                                  efforts to keep our Services
                                                  safe and secure, including

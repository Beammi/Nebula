    ...
    >
      <div className="rounded-lg shadow-md bg-dim-grey lg:w-[60rem] font-bold text-black p-7 ">
        <div className="flex justify-start my-2 lg:px-0 px-7">
          <h3 className="text-2xl text-black flex gap-x-3"><figure className="mx-2"> <Image src={filledoutBlueBookmark} alt="pic" width={27}/> </figure> Bookmark items</h3>
          <div className="ml-auto dropdown dropdown-end dropdown-hover mr-4">
            <div tabIndex={0} role="button" className="btn btn-sm m-1 normal-case bg-white drop-shadow-md text-black border-none hover:border-none hover:bg-grey flex flex-nowrap">Filter <figure className=''><Image src={filterIcon} alt="pic" className="" width={22}/></figure> </div>

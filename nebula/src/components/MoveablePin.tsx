...
export default function MoveablePin() {
  ...
  return (
      <div className=" absolute w-20 h-20 top-1/2 left-1/2 rounded-lg tranforms -translate-x-1/2 -translate-y-1/2 pb-40">
        <Image src={largePinIcon} alt="clsbtn" className=""/>
      </div>
  );
}

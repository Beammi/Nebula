...
export default function MoveablePin() {
  ...
  return (
      <div className=" absolute w-20 h-20 top-96 left-1/2 rounded-lg tranforms -translate-x-1/2 -translate-y-1/2">
        <Image src={largePinIcon} alt="clsbtn" className="pt-6 md:pt-12"/>
      </div>
  );
}
